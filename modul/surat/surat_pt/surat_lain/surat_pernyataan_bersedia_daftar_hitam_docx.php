...
$section->addText("Demikian Surat Pernyataan ini kami buat dengan sadar dan sebenarnya serta agar dapat dipergunakan sebagai kelengkapan dalam persyaratan Dokumen Kualifikasi Pekerjaan $judul $nama_jurusan UIN Sunan Gunung Djati Bandung Tahun $tahun untuk dapat dipergunakan sebagaimana mestinya.", $fontStyleName, $isiParagrafStyle2);
}else{
