...
//mulai isi word -- 
$section->addText("PAKTA INTEGRITAS", $boldJudulFontStyleName, $judulParagrafStyle);
...
$section->addListItem('Tidak melakukan tindak korupsi, kolusi dan nepotisme (KKN);', 0, $fontStyleName,'multilevel');
$section->addListItem('Akan melaporkan kepada APIP Kementrian Agama dan/atau LKPP apabila mengetahui ada indikasi KKN didalam proses pengadaan ini;', 0, $fontStyleName,'multilevel');
$section->addListItem('Akan mengikuti proses pengadaan secara bersih, transparan dan profesional untuk memberikan hasil kerja terbaik sesuai ketentuan peraturan perundang-undangan;', 0, $fontStyleName,'multilevel');
$section->addListItem('Apabila melanggar hal-hal yang dinyatakan dalam PAKTA INTEGRITAS ini, bersedia menerima sanksi administratif, menerima sanksi pencantuman dalam Daftar Hitam, digugat secara perdata dan/atau dilaporkan secara pidana.', 0, $fontStyleName,'multilevel');
