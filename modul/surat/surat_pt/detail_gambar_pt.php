          ...
          <div id="form" class="box box-success" style="display:none;">
            ...
            <div class="box-footer clearfix">
                  <div class="pull-right">
                        <a href="http://localhost/aparatt/aparat/index.php?page=surat_pt&act=detail_surat_pt&id=<?=$_GET['id_surat']?>" class="btn btn-sm btn-success btn-flat"><span class=""></span>Kembali</a>
                  </div>
            </div>
            <!-- /.box-footer -->
            <?php
