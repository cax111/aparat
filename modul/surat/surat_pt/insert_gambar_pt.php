<form method="post" accept-charset="utf-8" enctype="multipart/form-data"> 
    <div id="form" style="display:none" class="box box-success">
        <div class="box-header">
            ...
            <h3 class="box-title">Input Gambar Barang dan Link Sumber untuk Surat Spesifikasi Teknis   </h3>
            <h5>Gambar Barang</h5>
            <input class="" type="file" name="gambar"  required="required" >
            <h5>Link Barang</h5>
            <input class="form-control" type="text" name="link" placeholder="Link Gambar Barang" required="required" >                
            <br/>
