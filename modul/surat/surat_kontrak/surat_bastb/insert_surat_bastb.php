...
<form action="" method="post" accept-charset="utf-8"> 
  <div id="form" style="display:none" class="box box-danger">
    <div class="box-header">
      ...
      <h3 class="box-title">Input Data Surat Berita Acara Serah Terima Barang (BASTB)</h3>
    ...
    <?php
      ...
      if(isset($_POST['ok'])){
        $status = $surat_bastb->insertBASTB($_POST['nomor'],$_GET['id_surat']);      
