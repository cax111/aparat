...
<form action="" method="post" accept-charset="utf-8"> 
  <div id="form" style="display:none" class="box box-danger">
    <div class="box-header">
      ...
      <h3 class="box-title">Update Data Surat Pesanan (SP)</h3>
              
      <h5>Nomor Surat</h5>
      <input class="form-control" type="text" name="nomor" value="<?=$t['nomor_sp']?>" required="required" >
      <br/>
<?php
  }
?>
    ...
    <?php
      if(isset($_POST['ok'])){
        $status = $surat_sp->insertSP($_POST['nomor'],$_GET['id']);      
