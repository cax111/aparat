<!-- TABLE: LATEST ORDERS -->
          <div id="form" class="box box-success" style="display:none;">
            <div class="box-header with-border">
              <h3 class="box-title">Detail Data Surat Pemasukan/Pembukaan Surat Penawaran Harga</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  <thead>
                    ...
                    <?php
                        $tampil=$surat_ppsph->tampilPPSPH($_GET['id']); 
                        foreach($tampil AS $t){
                    ?>
                  <tr>
                    <th>Nama Surat</th>
                    <td>: Surat Pemasukan/Pembukaan Surat Penawaran Harga (PPSPH)</td>
                  </tr>
                  </thead>
                  <tbody>
                  <tr>
