...
$section->addText("\tRapat\t\t: Pemasukan/Pembukaan Surat Penawarah Harga", $fontStyleName, $isiParagrafStyle2);
$section->addText("\tHari\t\t: ".$pengaturan->tanggalToNamaHari($_POST['tanggal_bappsph']), $fontStyleName, $isiParagrafStyle2);
$section->addText("\tTanggal\t: ".$tanggal_bappsph, $fontStyleName, $isiParagrafStyle2);
$section->addText("\tPukul\t\t: Pukul ".$waktu_ppsph." s/d selesai", $fontStyleName, $isiParagrafStyle2);
$section->addText('', $boldFontStyleName, $isiParagrafStyle2);
//tambahkan tabel
