...
$namaPanitia->addListItem("$jabatan_panitia[0]", 1, $ttdFontStyleName,'multilevelLHKNH', $isiParagrafStyle2);
...
$namaPanitia->addListItem("$jabatan_panitia[1]", 1, $ttdFontStyleName,'multilevelLHKNH', $isiParagrafStyle2);
$table->addCell()->addText(".....................................", $fontStyle, array('spaceAfter' => 0, 'align' => 'center'));
$table->addRow();
...
$namaPanitia->addListItem("$jabatan_panitia[2]", 1, $ttdFontStyleName,'multilevelLHKNH', $isiParagrafStyle2);
$table->addCell()->addText(".....................................", $fontStyle, array('spaceAfter' => 0, 'align' => 'center'));
//end tabel
