<!-- TABLE: LATEST ORDERS -->
          <div id="form" class="box box-success" style="display:none;">
            <div class="box-header with-border">
              <h3 class="box-title">Detail Data Surat Berita Acara Klarifikasi dan Negosiasi Harga</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="table-responsive">
                <table class="table no-margin">
                  ...
                  <tr>
                    <th>Nama Surat</th>
                    <td>: Surat Berita Acara Klarifikasi dan Negosiasi Harga (BAKNH)</td>
                  </tr>
                  </thead>
                  <tbody>
                  <tr>
                  ...
                  <tr>
                    <th>Tanggal Surat</th>
                    <td><?=": ".$pengaturan->formatTanggal($t['tanggal_baknh']); ?></td>
                  </tr>
                  </tbody>
                </table>
              </div>
