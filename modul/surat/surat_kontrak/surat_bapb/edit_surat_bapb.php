<?php
    $tampil = $surat_bapb->tampilBAPB($_GET['id']);
    foreach($tampil AS $t){
?>
<form action="" method="post" accept-charset="utf-8"> 
  <div id="form" style="display:none" class="box box-danger">
    <div class="box-header">
      ...
      <h3 class="box-title">Input Data Surat Berita Acara Pemeriksaan Barang (BAPB)</h3>
              
      <h5>Nomor Surat</h5>
      <input class="form-control" type="text" name="nomor" value="<?=$t['nomor_bapb']?>" required="required" >
      <br/>
<?php
  }
?>
    ...
    <?php
      if(isset($_POST['ok'])){
        $status = $surat_bapb->insertBAPB($_POST['nomor'],$_GET['id']);      
