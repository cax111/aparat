...
<table class="table no-margin">
  ...
  <tbody>
    <?php
        ...
        $tampil=$surat_spk->tampil_spkbarang($querytambahan,$id);
        if(!empty($tampil)){
          foreach($tampil AS $t){
    ?>
      <tr>
  ...
  <input type="hidden" name="" id="id_barang" value="<?php echo $t['id_barang']; ?>">
                ...
                <input class="form-control" type="text" name="dasar" id="harga_dasar_hps"  readonly value="<?php echo $t['harga_dasar_penawaran'] ?>" required="required" >
                <h5>Harga Dasar SPK</h5>
...
<hr>
    ...
    ?>
          <tr>
            <td colspan="3">Data Penawaran Tidak Ditemukan.</td>
          </tr>
    <?php
        }
    ?>
    ...
    $(document).ready(function(){
      ...
      $("#harga_dasar").keyup(function(){
            ...
            if(isi >= harga_dasar_hps){
                ...
                $('#peringatan').html('<small style="color:red;">*Harga SPK tidak boleh lebih besar</small>');
      ...
      var id_barang = $("#id_barang").val();
        ...
        if( cek == "" || harga_dasar == ""){
          ...
          $.ajax({
                    type : "POST",
                    url  : "modul/perhitungan/php/input_spk.php",
                    //dataType : "JSON",
                    ...
                    success: function(){
                      ...
                      $('#peringatan2').show(1000);
                      $('#peringatan2').hide(1000);
                      $('#status_penawaran').load("modul/perhitungan/status_spk.php?id="+id_barang);
